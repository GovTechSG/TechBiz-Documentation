...
> **Note**: **Approvers** using SE-GSIB/GoMax device must respond to the email by selecting the Reply All option and copying (CC) the email to enquiries_ENP@tech.gov.sg in order to complete the approval process.
